//1) Crie um padrão para validação de Ceps
console.log('Validaçaõ de CEPS!')
const regexpCEP = /\d{5}[-\s]?\d{3}/g;

//validar todos estes exemplos
const ceps = [
  '00000-000',
  '00000 000',
  '00000000'
...
console.log('\n\nValidação de CPFS!')
//2) Crie um padrão para validação de Cpfs
...
console.log('\nValidação de CNPJ!')
//3) Crie um padrão para validação de CNPJ
...
//4) Crie um padrão para validação de telefones
...
console.log('\n\nValidação de Emails!')
//5) Crie um padrão para validação de emails 
...
console.log('\n\n\nValidação de tags!')
//6) Crie um padrão para validação de Tags
